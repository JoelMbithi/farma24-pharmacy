...
export default function LinkList({ mode = "marketing" }: { mode?: Mode }) {
    ...
    return (
      <li>
        <a
          ...
          className="group flex items-center gap-3 rounded-lg  bg-white px-4 py-3.5 transition-colors duration-150 hover:bg-white/4 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-blue"
        >
          <span
  ...
  return (
    <>
      {/* ============================================================
          MARKETING TRUST LINE (offer is now in <FeaturedEvent />)
      ============================================================ */}
    {isMarketing && (
